...
const AddCoursePage = () => {
    ...
    try {
        ...
        if (response.status === 200) {
            // Course adding was successful, navigate to a success screen
            console.log("Course added successfully");
            setAddCourseError("Course added successfully!");
        } else if (response.status === 400) {
            // Bad request (e.g., missing fields)
            setAddCourseError("Unable to add course. Please try again.");
        } else if (response.status === 409) {
            // Course already exists with the inputted courseCode
            setAddCourseError("A course already exists under this course code.");
        } else {
            ...
            <div className="geometric-background flex-grow flex items-center justify-center">
                <div className="bg-white p-8 rounded-lg shadow-md w-full sm:w-2/3 lg:w-1/2">
                    <h1 className="text-3xl font-semibold text-center mb-4 text-newsecond">
                     ...
                     <div>
                        <label htmlFor="University" className="block text-sm font-semibold text-text" >
                            Select a university below:
                        </label>
                        <select name="University" className="select w-full max-w-xs" value={selectedUniversity} onChange={handleUniversityChange}>
                     ...
                     <div>
                        <label htmlFor="courseCode" className="block text-sm font-semibold text-text">
                     ...
                     <div>
                        <label htmlFor="courseName" className="block text-sm font-semibold text-text">
                     ...
                     <div>
                        <label htmlFor="averageGrade" className="block text-sm font-semibold text-text">
                     ...
                     <div>
                        <label htmlFor="courseDesc" className="block text-sm font-semibold text-text">
                     ...
                     <div>
                        <label htmlFor="profFirstname" className="block text-sm font-semibold text-text">
                     ...
                     <div>
                        <label htmlFor="profLastname" className="block text-sm font-semibold text-text">
                     ...
                     <div>
                        <label htmlFor="tags" className="block text-sm font-semibold text-text">
                     ...
                     <div>
                        <label htmlFor="term" className="block text-sm font-semibold text-text">
                     ...
                     <div>
                        <label htmlFor="syllabus" className="block text-sm font-semibold text-text">
                     ...
                     <button
                     className="btn btn-secondary" type="submit" onClick={handleSubmit} >
                        Submit
                     </button>
                     {addCourseError && (
